...
setup(cmdclass=cmdclass,
      ...
      packages=["Bcfg2",
                ...
                "Bcfg2.Server.Reporting",
                "Bcfg2.Server.Reporting.Storage",
                "Bcfg2.Server.Reporting.Transport",
                "Bcfg2.Server.Reporting.migrations",
                "Bcfg2.Server.Reporting.templatetags",
